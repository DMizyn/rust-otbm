...
impl Item {
    ...
    pub fn is_blocking(&self) -> bool {
        self.get_boolean(&ItemAttribute::Blocksolid).unwrap_or(false) ||
        self.get_boolean(&ItemAttribute::Blockpathfind).unwrap_or(false)
    }
    ...
    pub fn is_pickupable(&self) -> bool {
        self.get_boolean(&ItemAttribute::Pickupable).unwrap_or(false)
    }
    ...
    pub fn name(&self) -> &str {
        self.get_string(&ItemAttribute::Name).unwrap_or("unknown item")
    }
    ...
    pub fn light_color(&self) -> (u8, u8, u8) {
        self.get_color(&ItemAttribute::LightColor).unwrap_or((0, 0, 0))
    }
}